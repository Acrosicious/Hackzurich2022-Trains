...
namespace GoogleARCore.Examples.Common
{
    ...
    {
        public bool _anchorSet = false;
        public bool _trackingLost = false;
        /// <summary>
        ...
        private List<GameObject> _planeVisuals = new List<GameObject>();
        ...
        public void Update()
        {
            ...
            if (_anchorSet && !_trackingLost && _planeVisuals.Count > 0) //tracking not lost, deactivate visuals
            {
                foreach (GameObject obj in _planeVisuals)
                {
